...
static int enable_port(struct unreal_poe *poe, unsigned int port, bool enable)
{
	struct unreal_cmd enable_port = {
		.raw = { 0x00, 0x00, port, enable },
		.len = 4,
	};
